<?php
/*
Template Name: Content with Images 2
*/
...
<?php foreach ($contentBlocks as $index => $block): ?>
    <div class="content <?php echo $index % 2 == 0 ? 'content-right' : ''; ?>">
        <?php if ($index % 2 == 1 && $block['image']): ?>
            <div class="content-image content-image-50">
                <img src="<?php echo esc_url($block['image']['url']); ?>"
                     alt="<?php echo esc_attr($block['image']['alt']); ?>">
            </div>
        <?php endif; ?>
        <div class="content-text content-text-50 <?php echo $index % 2 == 1 ? 'content-background-3' : 'content-background-5'; ?>">
            <?php if ($block['title']): ?>
