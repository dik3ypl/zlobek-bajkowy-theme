        ...
        <?php if (have_rows('slider')): ?>
            <?php while (have_rows('slider')): the_row(); ?>
                <div class="slider-element">
                    ...
                    <img src="<?php echo esc_url($slider_image['url']); ?>" alt="<?php the_sub_field('slider_text'); ?>">
...
<div class="page-card-container">
    <a href="<?php the_field('tile1_link'); ?>" class="page-card page-card-1-additional page-card-1">
        <h3><?php the_field('tile1_title'); ?></h3>
        <p><?php the_field('tile1_content'); ?></p>
    </a>
    <a href="<?php the_field('tile2_link'); ?>" class="page-card page-card-2-additional page-card-2">
        <h3><?php the_field('tile2_title'); ?></h3>
        <p><?php the_field('tile2_content'); ?></p>
    </a>
    <a href="<?php the_field('tile3_link'); ?>" class="page-card page-card-3-additional page-card-3">
        <h3><?php the_field('tile3_title'); ?></h3>
        <p><?php the_field('tile3_content'); ?></p>
    </a>
</div>

<a href="<?php the_field('tile_bottom_link'); ?>" class="banner-with-image-right">
...
if ($latest_post->have_posts()) :
    while ($latest_post->have_posts()) : $latest_post->the_post();
        ...
        ?>
        <a class="banner-with-image-left" href="<?php the_permalink(); ?>">
